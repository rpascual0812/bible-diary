...
const strings = {
  ...
  welcomeDesc: {
    en: "Welcome to Daily Healing Word. Ask any Bible or theology question.",
    fil: "Maligayang pagdating sa Daily Healing Word. Magtanong tungkol sa Bibliya.",
    ceb: "Maayong pag-abot sa Daily Healing Word. Pangutana bahin sa Bibliya.",
    bik: "Marhay na pag-abot sa Daily Healing Word. Maghapot manungod sa Biblia.",
    ilo: "Naimbag a panagparangyo ditoy Daily Healing Word. Agsaludsod maipanggep iti Biblia.",
    hil: "Maayo nga pag-abot sa Daily Healing Word. Mamangkot nahanungod sa Biblia.",
    es: "Bienvenido a Daily Healing Word. Pregunta sobre la Biblia o teología.",
    la: "Salve in Daily Healing Word. Quaere de Scriptura Sacra vel theologia.",
    el: "Καλώς ήρθατε στο Daily Healing Word. Ρωτήστε για τη Βίβλο ή τη θεολογία.",
  },
  placeholderOnline: {
    en: "Search Daily Healing Word...",
    fil: "Magtanong sa Daily Healing Word...",
    ceb: "Pangutana sa Daily Healing Word...",
    bik: "Maghapot sa Daily Healing Word...",
    ilo: "Agsaludsod iti Daily Healing Word...",
    hil: "Mamangkot sa Daily Healing Word...",
    es: "Pregunta a Daily Healing Word...",
    la: "Quaere Daily Healing Word...",
    el: "Ρωτήστε το Daily Healing Word...",
  },
  placeholderOffline: {
  ...
  donationSubtitle: {
    en: "Your generous contribution helps pay for Daily Healing Word AI costs and supports church missions.",
    fil: "Ang inyong handog ay makatutulong sa gastusin sa AI ng Daily Healing Word at sa mga misyon ng simbahan.",
    ceb: "Ang inyong halad makatabang sa AI nga gasto sa Daily Healing Word ug sa mga misyon sa simbahan.",
    bik: "An saimong alay makakatabang sa AI kan Daily Healing Word asin sa mga misyon kan simbahan.",
    ilo: "Ti datonyo ket makatulong iti gastos ti AI ti Daily Healing Word ken kadagiti misyon ti simbaan.",
    hil: "Ang inyo halad makabulig sa AI sang Daily Healing Word kag sa misyon sang simbahan.",
    es: "Su ofrenda ayuda con los costos de IA de Daily Healing Word y las misiones de la iglesia.",
    la: "Donatio tua adiuvat impensas AI Daily Healing Word et missiones ecclesiae.",
    el: "Η δωρεά σας υποστηρίζει το AI του Daily Healing Word και τις εκκλησιαστικές αποστολές.",
  },
  donationAmountLabel: {
