...
const strings = {
  ...
  donationSubmit: {
    en: "Proceed with Xendit Checkout",
    fil: "Magpatuloy sa Xendit Checkout",
    ceb: "Ipadayon sa Xendit Checkout",
    bik: "Ipadagos sa Xendit Checkout",
    ilo: "Ituloy iti Xendit Checkout",
    hil: "Magpadayon sa Xendit Checkout",
    es: "Continuar con Xendit",
    la: "Perge ad Xendit Checkout",
    el: "Συνέχεια με Xendit",
  },
  ...
  donationReadyDesc: {
    en: "Open Xendit to complete your contribution securely.",
    fil: "Buksan ang Xendit para makumpleto ang handog nang ligtas.",
    ceb: "Ablihi ang Xendit aron makompleto ang halad nga luwas.",
    bik: "Buksan an Xendit para makumpleto an alay na ligtas.",
    ilo: "Lukatan ti Xendit tapno mailpas a natalged ti daton.",
    hil: "Buksa ang Xendit agod makompleto ang ihalad nga luwas.",
    es: "Abre Xendit para completar tu ofrenda de forma segura.",
    la: "Aperi Xendit ut oblationem secure perficias.",
    el: "Ανοίξτε το Xendit για ασφαλή ολοκλήρωση της δωρεάς.",
  },
  donationManualTitle: {
