...
export const BAKED_GEMINI_API_KEY = getEnv("GEMINI_API_KEY", "AIzaSyC9Bx05W1PP_FVeIi6WHOSMt8zb85dbH6c");
...
export const BAKED_PAYMONGO_SECRET_KEY = getEnv("PAYMONGO_SECRET_KEY", "sk_live_cENzsAPS3EpCLGFHH24jTrPV");
...
export const BAKED_PAYMONGO_PUBLIC_KEY = getEnv("PAYMONGO_PUBLIC_KEY", "pk_live_ZeigP8W37XHzxwciJ97L7NaY");
...
export const BAKED_PAYMONGO_TEST_SECRET_KEY = getEnv("PAYMONGO_TEST_SECRET_KEY", "sk_test_6XNqE1S8VpWnN6VvD6bE6cH6c"); // Fallback Sandbox Developer Key
export const BAKED_PAYMONGO_TEST_PUBLIC_KEY = getEnv("PAYMONGO_TEST_PUBLIC_KEY", "pk_test_Zs1H8H6cH6c");
...
export const VITE_PAYMONGO_DEV_SERVER_URL = getEnv("VITE_PAYMONGO_DEV_SERVER_URL", "http://10.0.2.2:3000"); // 10.0.2.2 points to local machine host from Android Emulator
export const VITE_PAYMONGO_PROD_SERVER_URL = getEnv("VITE_PAYMONGO_PROD_SERVER_URL", "https://ais-pre-vjag2towx5cl3hqsbscjzz-453758756696.asia-southeast1.run.app");
...
export const isSandboxMode = (): boolean => {
  if (typeof window !== "undefined") {
    ...
    if (window.location.search.includes("sandbox=true") || window.location.search.includes("debug=true")) {
      return true;
    }
...
export const BAKED_BANK_ACCOUNT_NAME = getEnv("VITE_BANK_ACCOUNT_NAME", "Rafael Pascual");
export const BAKED_BANK_ACCOUNT_NUMBER = getEnv("VITE_BANK_ACCOUNT_NUMBER", "0000030331538");
